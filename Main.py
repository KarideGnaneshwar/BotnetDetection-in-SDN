...
main = Tk()
main.title("Detecting and Mitigating Botnet Attacks in Software-Defined Networks Using Deep Learning Techniques")
...
def preprocessDataset():
    ...
    text.insert(END,"Total Spectogram Images found in dataset : "+str(X.shape[0])+"\n")
    text.insert(END,"80% Spectogram Images used for training  : "+str(X_train.shape[0])+"\n")
    text.insert(END,"20% Spectogram Images used for testing   : "+str(X_test.shape[0])+"\n")
...
def graph():
    df = pd.DataFrame([['CNN1D','Accuracy',accuracy[0]],['CNN1D','Precision',precision[0]],['CNN1D','Recall',recall[0]],['CNN1D','FSCORE',fscore[0]],
                       ...
                       ['SDCNN','Accuracy',accuracy[3]],['SDCNN','Precision',precision[3]],['SDCNN','Recall',recall[3]],['SDCNN','FSCORE',fscore[3]],
...
font = ('times', 15, 'bold')
title = Label(main, text='Detecting and Mitigating Botnet Attacks in Software-Defined Networks Using Deep Learning Techniques')
...
uploadButton = TkinterCustomButton(text="Upload CIC-2017-IDS Spectrogram Dataset", width=400, corner_radius=5, command=uploadDataset)
uploadButton.place(x=50,y=150)

processButton = TkinterCustomButton(text="Preprocess Spectrogram Images ", width=300, corner_radius=5, command=preprocessDataset)
